...
public interface FacadeTicTacToeOnLine {
    ...
    String creerPartie(String joueur1) throws PseudoIncorrectException, PseudoDejaDansUnePartieException;

    void rejoindrePartie(String joueur2,String jeton) throws PartieInexistanteException, PseudoIncorrectException, PseudoDejaDansUnePartieException;
    ...
    void jouer(String nomJoueur, int x, int y) throws CoupIncorrectException,
            CaseDejaOccupeeException, PartieInexistanteException, PasVotreTourException, PartieTermineeException;
     ...
     */
    String getGagnant(String nomJoueur) throws PartieNonTermineeException, EgaliteException, PartieInexistanteException;
     ...
     */
    String getJoueurCourant(String nomJoueur) throws PartieInexistanteException;
